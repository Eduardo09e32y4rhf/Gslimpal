...
O site da Gslimp visa devolver a vida e a saúde aos estofados de seus clientes.

Slogan Principal: Gslimp - Devolva a Vida e a Saúde aos Seus Estofados.

Foco: Higienização e limpeza profunda, eliminando ácaros, bactérias e manchas. Qualidade que o cliente vê e sente.

🛠️ Estrutura do Projeto
O projeto é composto pelos seguintes arquivos principais:

index.html: O esqueleto principal do site, contendo todo o conteúdo, seções e a estrutura do layout.
